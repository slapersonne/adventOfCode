...
def run_11b():
    paintings = run_11a(1)
    paintings = {key: "#" if value == 1 else "." for key, value in paintings.items()}
    for y in range(50, -50, -1):
        print("".join([paintings.get((x, y), ".") for x in range (-50, 50)]))
